...
class Student:
    def __init__(self, root):
       ...
       # first image
        ...
        # bg image
        img3 = Image.open(
            r"D:\PR_101\project images\7100be04-c18c-4b33-ae41-7b4ef2cadadf.jpeg")
        ...
        img_left = Image.open(
            r"D:\PR_101\project images\IMG_20230308_114906.jpeg")
        ...
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="Yashvardhan@4882", database="face_recognition_system")
...
# ===========================fetch data=================
    def fetch_data(self):
        conn = mysql.connector.connect(host="localhost", username="root",
                                       password="Yashvardhan@4882", database="face_recognition_system")
        my_cursor = conn.cursor()
