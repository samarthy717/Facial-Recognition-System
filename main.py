...
class Face_recognition_System:
    def __init__(self,root):
        ...
        b1_1=Button(bg_lbl,text="Student Details",command=self.student_details,font=("times new roman",15,"bold"),bg="blue",fg="white",cursor="hand2")
        ...
        b1_1=Button(bg_lbl,text="Face Detector",command=self.face_data,font=("times new roman",15,"bold"),bg="blue",fg="white",cursor="hand2")
        ...
        b1=Button(bg_lbl,image=self.photoimg6,cursor="hand2",command=self.Train_data )
        b1.place(x=520,y=100,width=220,height=220)

        b1_1=Button(bg_lbl,text="Train Data", font=("times new roman",15,"bold"),bg="blue",fg="white",cursor="hand2",command=self.Train_data)
        ...
        b1=Button(bg_lbl,image=self.photoimg7,cursor="hand2",command=self.openImg)
        b1.place(x=520,y=380,width=220,height=220)

        b1_1=Button(bg_lbl,text="Photos",font=("times new roman",15,"bold"),bg="blue",fg="white",cursor="hand2",command=self.openImg)
