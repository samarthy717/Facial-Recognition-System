...
class Face_Recognition:
    def __init__(self, root):
        ...
        #1st image
        img_top = Image.open(r"D:\PR_101\project images\image bg.jpeg")
        ...
        #2st image
        img_bottom=Image.open(r"D:\PR_101\project images\face detector.jpeg")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                conn = mysql.connector.connect(host="localhost", username="root", password="Yashvardhan@4882", database="face_recognition_system")
